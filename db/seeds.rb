...
StudyRoom.create(category_id: 1, location_id: 1, start_time: DateTime.strptime("09/01/2017 17:00", "%m/%d/%Y %H:%M"), end_time: DateTime.strptime("09/01/2017 19:00", "%m/%d/%Y %H:%M"))
StudyRoom.create(category_id: 1, location_id: 2, start_time: DateTime.strptime("09/01/2019 17:00", "%m/%d/%Y %H:%M"), end_time: DateTime.strptime("11/01/2019 19:00", "%m/%d/%Y %H:%M"))
StudyRoom.create(category_id: 2, location_id: 1, start_time: DateTime.strptime("09/01/2019 17:00", "%m/%d/%Y %H:%M"), end_time: DateTime.strptime("11/01/2019 19:00", "%m/%d/%Y %H:%M"))
StudyRoom.create(category_id: 3, location_id: 3, start_time: DateTime.strptime("09/01/2019 17:00", "%m/%d/%Y %H:%M"), end_time: DateTime.strptime("11/01/2019 19:00", "%m/%d/%Y %H:%M"))
StudyRoom.create(category_id: 4, location_id: 2, start_time: DateTime.strptime("09/01/2019 17:00", "%m/%d/%Y %H:%M"), end_time: DateTime.strptime("11/01/2019 19:00", "%m/%d/%Y %H:%M"))
