...
UserStudyRoom.find_or_create_by(user_id: 1, study_room_id: 1)
UserStudyRoom.find_or_create_by(user_id: 1, study_room_id: 2)
UserStudyRoom.find_or_create_by(user_id: 2, study_room_id: 3)
UserStudyRoom.find_or_create_by(user_id: 4, study_room_id: 2)
UserStudyRoom.find_or_create_by(user_id: 4, study_room_id: 3)
UserStudyRoom.find_or_create_by(user_id: 3, study_room_id: 4)
UserStudyRoom.find_or_create_by(user_id: 5, study_room_id: 2)
UserStudyRoom.find_or_create_by(user_id: 1, study_room_id: 1)
UserStudyRoom.find_or_create_by(user_id: 1, study_room_id: 3, owner: true)
UserStudyRoom.find_or_create_by(user_id: 1, study_room_id: 4, owner: true)
UserStudyRoom.find_or_create_by(user_id: 1, study_room_id: 3, owner: true)
UserStudyRoom.find_or_create_by(user_id: 1, study_room_id: 5, owner: true)
